...
LicenseFile=/home/ben/devel/QCADesigner-2.0.3-modified\share\doc\QCADesigner-2.0.3\COPYING
ChangesAssociations=yes
OutputBaseFilename=QCADesigner-2.0.3-setup-gtk
...
Root: HKLM; Subkey: "Software\Microsoft\Windows\CurrentVersion\App Paths\graph_dialog.exe"; ValueType: string; ValueData: "{app}\bin\QCADesigner.exe"; Flags: uninsdeletevalue
...
Root: HKCR; SubKey: "QCADesigner.File\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\share\QCADesigner\pixmaps\QCADesigner.winxp.ico"; MinVersion: 0, 1
Root: HKCR; SubKey: "QCADesigner.File\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\share\QCADesigner\pixmaps\QCADesigner.win32.ico"; MinVersion: 1, 0
...
Root: HKCR; SubKey: "QCADesigner.SimResults.File\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\share\QCADesigner\pixmaps\graph_dialog.winxp.ico"; MinVersion: 0, 1
Root: HKCR; SubKey: "QCADesigner.SimResults.File\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\share\QCADesigner\pixmaps\graph_dialog.win32.ico"; MinVersion: 1, 0
...
Root: HKCR; SubKey: "QCADesigner.SimResults.File\shell\Open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\bin\graph_dialog.exe"" ""%1"""

[Files]
Source: "/home/ben/devel/QCADesigner-2.0.3-modified\*"; DestDir: "{app}"; Flags: recursesubdirs
Source: "/home/ben/devel/QCADesigner-2.0.3-modified\gtk-runtime-2.6.8-rev-a.exe"; DestDir: "{tmp}"; Flags: dontcopy
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
Name: "{group}\QCADesigner"; Filename: "{app}\bin\QCADesigner.exe"; IconFilename: "{app}\share\QCADesigner\pixmaps\QCADesigner.winxp.ico"; MinVersion: 0, 1
Name: "{group}\Simulation Results Viewer"; Filename: "{app}\bin\graph_dialog.exe"; IconFilename: "{app}\share\QCADesigner\pixmaps\graph_dialog.winxp.ico"; MinVersion: 0, 1
Name: "{userdesktop}\QCADesigner"; Filename: "{app}\bin\QCADesigner.exe"; Tasks: desktopicon; IconFilename: "{app}\share\QCADesigner\pixmaps\QCADesigner.winxp.ico"; MinVersion: 0, 1

Name: "{group}\QCADesigner"; Filename: "{app}\bin\QCADesigner.exe"; IconFilename: "{app}\share\QCADesigner\pixmaps\QCADesigner.win32.ico"; MinVersion: 1, 0
Name: "{group}\Simulation Results Viewer"; Filename: "{app}\bin\graph_dialog.exe"; IconFilename: "{app}\share\QCADesigner\pixmaps\graph_dialog.win32.ico"; MinVersion: 1, 0
Name: "{userdesktop}\QCADesigner"; Filename: "{app}\bin\QCADesigner.exe"; Tasks: desktopicon; IconFilename: "{app}\share\QCADesigner\pixmaps\QCADesigner.win32.ico"; MinVersion: 1, 0
...
function EnsureGtkInstalled ():Boolean;
  ...
  if not Result then
    iMsgBox := MsgBox('QCADesigner requires GTK+ version 2.2 or higher. Would you like to install it ?', mbConfirmation, MB_YESNO) ;
    begin
    ...
    if idYes = iMsgBox then
      begin
      ExtractTemporaryFile ('gtk-runtime-2.6.8-rev-a.exe');
      Exec (ExpandConstant ('{tmp}')+'\gtk-runtime-2.6.8-rev-a.exe',
...
begin
  ...
  if not Result then begin
    MsgBox ('Please install the GTK+ Runtime Environment version 2.2 or higher before installing QCADesigner. You can obtain GTK+ from http://gaim.sourceforge.net/win32/index.php#wingtk . Look for files of the form gtk-runtime-<Version>.exe', mbError, MB_OK);
  end;
end;
